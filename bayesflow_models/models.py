...
def simulator_1a(drift, boundary, beta, mu_tau_e, tau_m, sigma, varsigma, number_of_trials, dc=1.0, dt=0.005):
    x_all = []
    x = []
...
def simulator_1b(drift, boundary, beta, mu_tau_e, mu_tau_m, sigma, varsigma, number_of_trials, dc=1.0, dt=0.005):
    x_all = []
    x = []
    for _ in range(number_of_trials):
        n_steps = 0.
...
def simulator_1c(drift, boundary, beta, mu_tau_e, tau_m, sigma, varsigma, number_of_trials, dc=1.0, dt=0.005):
    x_all = []
    x = []
    for _ in range(number_of_trials):
        n_steps = 0.
...
def simulator_2(drift, boundary, beta, mu_tau_e, tau_m, sigma, varsigma, gamma, number_of_trials, dc=1.0, dt=0.005):
    x_all = []
    x = []
    for _ in range(number_of_trials):
        n_steps = 0.
...
def simulator_3(drift, boundary, beta, mu_tau_e, tau_m, sigma, varsigma, theta, number_of_trials, dc=1.0, dt=0.005):
    x_all = []
    x = []
    for _ in range(number_of_trials):
        n_steps = 0.
...
def simulator_4a(drift, boundary, beta, mu_tau_e, tau_m, tau, sigma_e, sigma_k, varsigma, k, theta, number_of_trials, dc=1.0, dt=0.005):
    x_all = []
    x = []
    for _ in range(number_of_trials):
        n_steps = 0.
...
def simulator_4b(drift, boundary, beta, mu_tau_e, tau_m, sigma_e, varsigma, theta, number_of_trials, dc=1.0, dt=0.005):
...
def simulator_5(drift, boundary, beta, mu_tau_e, tau_m, sigma, varsigma, a_slope, number_of_trials, dc=1.0, dt=0.005):
...
def simulator_6(drift, boundary, beta, mu_tau_e, tau_m, sigma, varsigma, lamda, number_of_trials, dc=1.0, dt=0.005):
...
def simulator_7(mu_drift, boundary, beta, tau, sigma, eta, number_of_trials, dc=1.0, dt=0.005):
    x_all = []
    x = []
...
def simulator_8(mu_drift, boundary, tau, sigma, gamma, eta, number_of_trials, dc=1.0, dt=0.005):
    x_all = []
    x = []
    # trial-to-trial drift rate variability
...
def simulator_9(drift, boundary, beta, t_e, t_m, sigma_e, number_of_trials, dc=1.0, dt=0.005):
    x_all = []
    x = []
    for _ in range(number_of_trials):
        n_steps = 0.
...
def simulator_10(drift, boundary, beta, t_e, t_m, sigma_e, gamma, number_of_trials, dc=1.0, dt=0.005):
    x_all = []
    x = []
    for _ in range(number_of_trials):
        n_steps = 0.
...
def simulator_11(drift, boundary, beta, ndt, sigma, gamma, number_of_trials, dc=1.0, dt=0.005,max_steps=2e4):
    x_all = []
    x = []
    for _ in range(number_of_trials):
        n_steps = 0.
...
def simulator_12(drift, boundary, beta, ndt, eta, number_of_trials, dc=1.0, dt=0.005):
    x_all = []
    x = []
    for _ in range(number_of_trials):
        n_steps = 0.
...
def simulator_13(drift, boundary, beta, t_m, sigma_e, lam, k, number_of_trials, dc=1.0, dt=0.005):
    x_all = []
    x = []
    for _ in range(number_of_trials):
        n_steps = 0.
...
def meta():
    return {"number_of_trials": np.random.randint(60, 300)}
